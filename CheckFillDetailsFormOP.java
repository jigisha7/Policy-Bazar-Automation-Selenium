...
public class CheckFillDetailsFormOP {
...
public static WebDriver driver;
	...
	@Test(priority=2)
	public void validateCarDetailsWithOtherOption() throws InterruptedException
	{
		driver.findElement(By.xpath("//*[@id=\"before-tp\"]/div[2]/a")).click();
		Thread.sleep(2000);
		driver.findElement(By.id("searchOthers")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@id='react-autowhatever-1--item-0']/span")).click();
		Thread.sleep(2000);
		driver.findElement(By.id("searchOthers")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@id='react-autowhatever-1--item-0']/span")).click();
